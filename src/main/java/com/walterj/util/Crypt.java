...
public class Crypt
{
   ...
   /**
   ** Used to check if the supplied password matches the password
   ** for this contact.
   */
   static public boolean compare 
      (String clearPassword, String encryptedPassword)
   {
      String salt = encryptedPassword.substring(0, 2);
      String x = Crypt.crypt(salt, clearPassword);
	  
      return (encryptedPassword.equals(x));
   }
