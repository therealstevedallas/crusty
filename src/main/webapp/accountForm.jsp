...
<tr>
  <td> </td>
  <td><div class="formButton">
  <s:url var="cancelUrl" action="listAccounts"></s:url>
  <input type="button" value="${strings.get('button.cancel')}" id="cancel-button"/>
  <input type="submit" value="${strings.get('button.save')}" id="editAccount_saveAccount" name="action:saveAccount"/>
  </div></td>
</tr>
</table>
</form>
